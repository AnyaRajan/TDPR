...
from model.gnn_model import GNN  # Adjust path as necessary
...
def build_pyg_graph(features, labels=None, k=100):
    A = kneighbors_graph(features, k, mode='connectivity', include_self=False).toarray()
